  ...
  return (
    <div className="flex flex-col gap-6">
      <span className="text-[12.5px] font-medium uppercase tracking-[0.16em] text-ink-subtle">
        {t("Step 4 · Source language")}
      </span>
      <div className="flex flex-col gap-3">
        <h1 className="font-display text-[36px] font-medium leading-[1.08] tracking-tight text-ink">
          {t("Pick your preferred audio languages")}
        </h1>
        <p className="text-[15px] leading-relaxed text-ink-muted">
          {t(
            "MoviBox uses this order when ranking sources with different audio languages. Put your main language first.",
          )}
        </p>
      </div>
      <LanguagesPicker
