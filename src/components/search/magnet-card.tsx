import { AlertCircle, Download, FileVideo, Loader2, Magnet } from "lucide-react";
    ...
    <div className="flex items-center gap-4 rounded-2xl border border-accent/40 bg-accent/10 px-5 py-4">
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-0.5">
        ...
        <span className="text-[12.5px] text-ink-subtle">
          {error ?? "Downloads directly from peers over your own connection."}
        </span>
      </div>
      <button
        type="button"
      ...
      >
        ...
        {mode === "starting" ? "Starting" : "Download"}
      </button>
    </div>
  );
}
