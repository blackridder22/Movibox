      ...
      {!authKey && (
        <div className="rounded-2xl border border-amber-300/30 bg-amber-300/[0.06] px-5 py-4 text-[13.5px] text-ink">
          ...
          <p className="mt-1 text-ink-muted">
            {t(
              "Anything you install in MoviBox pushes back to your Stremio account so it shows up on mobile too. Sign in via the avatar in the bottom-left of the sidebar.",
            )}
          </p>
        </div>
      )}
