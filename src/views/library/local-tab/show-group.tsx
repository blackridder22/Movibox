...
export function episodeLabel(entry: LocalEntry): string | null {
...
export function ShowGroupCard({
  ...
  const onActivate = () => {
    ...
    void import("@tauri-apps/plugin-opener")
      .then(({ openPath }) => openPath(head.path))
      .catch((error) => console.warn("[movibox] could not open local episode externally", error));
  };
  return (
    <div
