  ...
  return (
    <>
      ...
      <Section
        ...
        subtitle={t("Make MoviBox yours: swap the sidebar logo and the window or taskbar icon.")}
      >
        <LogoPicker />
      </Section>
      ...
      <Section
        title={t("Typography")}
        subtitle={t(
          "Pick a display and body pairing, or upload your own font to use across MoviBox.",
        )}
      >
        <FontGrid
      ...
      {isTauri && (
        <Section
          ...
          subtitle={t(
            "Use your operating system's native title bar and window buttons instead of MoviBox's built-in controls.",
          )}
        >
          <NativeTitleBarRow />
        </Section>
    ...
    <div className="flex items-start gap-3 rounded-xl border border-edge-soft bg-canvas/40 px-4 py-3.5">
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-1">
        ...
        <p className="text-[12.5px] leading-relaxed text-ink-subtle">
          {t(
            "Show the operating system title bar with its minimize, maximize, and close buttons. Turn this off to use MoviBox's built-in controls.",
          )}
        </p>
      </div>
      <button
