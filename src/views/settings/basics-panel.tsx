import { ChevronRight, Eye, EyeOff, Languages, LogIn, Palette, Zap } from "lucide-react";
    ...
    <>
      <div className="flex flex-col gap-2.5">
        ...
        <LaunchRow
          ...
          sub={
            debridCount > 0
              ? t("A debrid service is connected and ready to resolve downloadable files.")
              : t(
                  "Connect Real-Debrid, TorBox, AllDebrid, Premiumize, or Debrid-Link for cached sources.",
                )
          }
      ...
      <div className="flex flex-col gap-2.5">
        <LaunchRow
          ...
          title={t("Languages")}
          sub={t("Pick which source and audio languages MoviBox ranks first.")}
          status={langLabel}
      ...
      >
        ...
        <div className="flex min-w-0 flex-1 flex-col gap-0.5">
          ...
          <span className="text-[12.5px] leading-snug text-ink-muted">
            {t("Sync your library, collections, and installed addons across devices.")}
          </span>
        </div>
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-0.5">
        ...
        <span className="flex items-center gap-2 text-[12.5px] leading-snug text-ink-muted">
          <span className="truncate tracking-wide">
            {email ? (reveal ? email : maskEmail(email)) : t("Your library and addons sync here.")}
          </span>
          {email && (
            <button
              type="button"
